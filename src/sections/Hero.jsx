  ...
  return (
    ...
    >
      ...
      <div className="relative xl:w-2/5 xl:items-start  flex flex-col  w-full padding-x pt-12  xl:left-[-100px] xl:mb-60 ">
        ...
        <p className=" mt-10 p-2  mr-20 text-left info-text font-palanquin xl:w-[400px] max-xl:w-full ">Discover over one  tusend of gradution projects that could be a point of intrest to you!</p>
